...
- Categorize companies by their sector: Analyze companies within a specific industry or sector, like Technology, Healthcare, or Consumer Goods.
...
Example Use Case
An investment firm could use the Available Sectors API to filter and analyze companies solely within the Technology sector, enabling them to track growth trends or potential opportunities in that market segment.
...
> 출처: https://site.financialmodelingprep.com/developer/docs/stable/available-sectors · 카테고리: directory
